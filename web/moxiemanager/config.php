<?php
    ...
    $moxieManagerConfig['SymfonyAuthenticator.logged_in_key'] = '_security_main';
    ...
    $moxieManagerConfig['basicauthenticator.users'] = array(
        array("username" => "nodevo", "password" => "xspevu", "groups" => array("administrator"))
    );
