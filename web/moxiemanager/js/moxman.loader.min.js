(function (exports, undefined) {
    "use strict";
    var modules  = {};
    var moxieUrl = 'http://preprod.hopitalnumerique.nodevo.com/moxiemanager';
    ...
    define(__moxman_Loader, [__moxman_util_Loader, __moxman_Env, __moxman_util_I18n], function (ResourceLoader, Env, I18n) {
        ...
        function loadAndRender(view) {
            return function (settings) {
                ...
                if (!moxman.ui) {
                    ResourceLoader.load({
                        js: [Env.baseUrl + "/js/moxman.api.min.js", Env.apiPageUrl + "?action=language" + (settings.language ? "&code=" + settings.language : ""), Env.apiPageUrl + "?action=PluginJs"],
