...
class ReferenceController extends Controller
{
    ...
    public function sitemapAction()
    {
        ...
        return $this->render('HopitalNumeriqueReferenceBundle:Reference:sitemap.html.twig', array(
            ...
            'orderedReferences' => $this->container->get('hopitalnumerique_reference.dependency_injection.reference.tree')->getOrderedReferences(null, null, $this->getUser()->getDomaines()),
