...
class ReferencementExtension extends \Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('referencement_note', [$this, 'getReferencementNote']),
            //@todo déplacer dans DomaineBundle
            new \Twig_SimpleFunction('domaines_communs_with_user', [$this, 'getEntityDomainesCommunsWithUser']),
        ];
    }
