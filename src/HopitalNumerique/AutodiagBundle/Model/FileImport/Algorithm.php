    ...
    public function validateFileContent(ExecutionContextInterface $context)
    {
        ...
        if (count($headers) !== 31
            || count(array_intersect($headers, [
                'algorithme',
                'libelle_valeur_referece_1',
                'calcul_valeur_reference_1',
                'couleur_reference_1',
                'libelle_valeur_referece_2',
                'calcul_valeur_reference_2',
                'couleur_reference_2',
                'libelle_valeur_referece_3',
                'calcul_valeur_reference_3',
                'couleur_reference_3',
                'libelle_valeur_referece_4',
                'calcul_valeur_reference_4',
                'couleur_reference_4',
                'libelle_valeur_referece_5',
                'calcul_valeur_reference_5',
                'couleur_reference_5',
                'libelle_valeur_referece_6',
                'calcul_valeur_reference_6',
                'couleur_reference_6',
                'libelle_valeur_referece_7',
                'calcul_valeur_reference_7',
                'couleur_reference_7',
                'libelle_valeur_referece_8',
                'calcul_valeur_reference_8',
                'couleur_reference_8',
                'libelle_valeur_referece_9',
                'calcul_valeur_reference_9',
                'couleur_reference_9',
                'libelle_valeur_referece_10',
