...
class FichierModifiableController extends Controller
{
    ...
    public function indexAction(Objet $objet)
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            return $this->redirect(($do == 'save-close' ? $this->generateUrl('hopitalnumerique_objet_objet_edit', ['id' => $objet->getId()]) : $this->generateUrl('hopitalnumerique_objet_administration_fichierModifiable', ['id' => $objet->getId()])));
        }

        return $this->render('HopitalNumeriqueObjetBundle:FichierModifiable:edit.html.twig', [
