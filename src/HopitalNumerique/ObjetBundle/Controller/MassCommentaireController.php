...
class MassCommentaireController extends Controller
{
    ...
    public function exportCsvAction($primaryKeys, $allPrimaryKeys)
    {
        ...
        $inscriptions = $this->get('hopitalnumerique_objet.manager.commentaire')->findBy(['id' => $primaryKeys]);
    ...
    public function publierMassAction($primaryKeys, $allPrimaryKeys)
    {
        ...
        $commentaires = $this->get('hopitalnumerique_objet.manager.commentaire')->findBy(['id' => $primaryKeys]);
