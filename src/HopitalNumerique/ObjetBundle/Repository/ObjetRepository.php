...
class ObjetRepository extends EntityRepository
{
    ...
    public function getDatasForGrid()
    {
        ...
        $qb->select('obj.id, obj.titre, obj.isInfraDoc, obj.isArticle, refEtat.libelle as etat, obj.dateCreation, obj.dateModification, obj.lock, obj.autodiags, user.email as lockedBy, refTypes.libelle as types')
