...
class AideController extends Controller
{
    ...
    {
        $aide = $this->get('hopitalnumerique_aide.manager.aide')->findOneBy(['id' => $id]);
    ...
    public function showAction($id)
    {
        ...
        return $this->render('HopitalNumeriqueAideBundle:Aide:show.html.twig', [
            'aide' => $aide,
        ]);
    }
    ...
    public function deleteMassAction($primaryKeys, $allPrimaryKeys)
    {
        ...
        $aides = $this->get('hopitalnumerique_aide.manager.aide')->findBy(['id' => $primaryKeys]);
    ...
    private function renderForm($formName, $aide, $view)
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect(($do == 'save-close' ? $this->generateUrl('hopitalnumerique_aide_aide') : $this->generateUrl('hopitalnumerique_aide_aide_edit', ['id' => $aide->getId()])));
            }
        }
    ...
    public function aideAction(Request $request)
    {
        ...
        //Récupération de l'entité en fonction du paramètre
        $aide = $this->get('hopitalnumerique_aide.manager.aide')->findOneBy(['route' => $route]);

        return $this->render('HopitalNumeriqueAideBundle:Aide:aide.html.twig', [
            'aide' => $aide,
            'route' => $route,
        ]);
    }
