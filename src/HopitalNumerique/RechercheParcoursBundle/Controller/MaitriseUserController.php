...
class MaitriseUserController extends Controller
{
    ...
    public function saveNoteAction(Request $request)
    {
        ...
        $note = $this->get('hopitalnumerique_recherche_parcours.manager.matrise_user')->findOneBy(['objet' => $idObjet, 'user' => $user, 'rechercheParcoursDetails' => $rechercheParcoursDetails]);
