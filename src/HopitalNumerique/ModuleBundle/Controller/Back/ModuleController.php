...
class ModuleController extends Controller
{
    ...
    public function addAction()
    {
        ...
        $module->setStatut($this->get('hopitalnumerique_reference.manager.reference')->findOneBy(['id' => 3]));
    ...
    public function editAction($id)
    {
        ...
        $module = $this->get('hopitalnumerique_module.manager.module')->findOneBy(['id' => $id]);
    ...
    public function showAction($id)
    {
        ...
        return $this->render('HopitalNumeriqueModuleBundle:Back/Module:show.html.twig', [
            'module' => $module,
        ]);
    }
    ...
    public function deleteMassAction($primaryKeys, $allPrimaryKeys)
    {
        ...
        $modules = $this->get('hopitalnumerique_module.manager.module')->findBy(['id' => $primaryKeys]);
    ...
    private function renderForm($formName, $module, $view)
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect(($do == 'save-close' ? $this->generateUrl('hopitalnumerique_module_module') : $this->generateUrl('hopitalnumerique_module_module_edit', ['id' => $module->getId()])));
            }
        }
