...
class BaseInscriptionGrid extends Grid implements GridInterface
{
    ...
    public function setActionsButtons()
    {
        ...
        $actionFicheEvaluation->setAttributes([
                'class' => 'btn btn-primary fa fa-list',
                'title' => 'Afficher le formulaire d\'évaluation',
                'target' => '_blank',
        ]);
        $actionFicheEvaluation->setRouteParametersMapping(['userId' => 'user', 'sessionId' => 'session']);
        $actionFicheEvaluation->setRouteParameters(['userId', 'sessionId']);
