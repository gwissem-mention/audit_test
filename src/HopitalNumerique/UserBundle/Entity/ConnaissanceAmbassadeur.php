...
/**
 * ConnaissanceAmbassadeur
 *
 * @ORM\Table(name="core_user_connaissances_ambassadeur")
 * @ORM\Entity(repositoryClass="HopitalNumerique\UserBundle\Repository\ConnaissanceAmbassadeurRepository")
 */
class ConnaissanceAmbassadeur
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="connaissancesAmbassadeurs", cascade={"persist"})
