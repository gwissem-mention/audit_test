...
class ContractualisationController extends Controller
{
    ...
    public function indexAction($id)
    {
        ...
        return $grid->render('HopitalNumeriqueUserBundle:Contractualisation:index.html.twig', [
                'utilisateur' => $user,
    ...
    public function addAction($id)
    {
        ...
        return $this->renderForm('hopitalnumerique_user_contractualisation', $contractualisation, 'HopitalNumeriqueUserBundle:Contractualisation:edit.html.twig', [
    ...
    public function editAction($id)
    {
        ...
        $contractualisation = $this->get('hopitalnumerique_user.manager.contractualisation')->findOneBy(['id' => $id]);
    ...
    public function showAction($id)
    {
        ...
        return $this->render('HopitalNumeriqueUserBundle:Contractualisation:show.html.twig', [
    ...
    public function deleteAction($id)
    {
        ...
        return new Response('{"success":true, "url" : "' . $this->generateUrl('hopitalnumerique_user_contractualisation', ['id' => $contractualisation->getuser()->getId()]) . '"}', 200);
    }
    ...
    public function archiverAction($id)
    {
        ...
        return $this->redirect($this->generateUrl('hopitalnumerique_user_contractualisation', ['id' => $contractualisation->getuser()->getId()]));
    }
    ...
    public function listeAction($idUser)
    {
        ...
        $contractualisations = $this->get('hopitalnumerique_user.manager.contractualisation')->findBy(['user' => $idUser]);

        return $this->render('HopitalNumeriqueUserBundle:Contractualisation:liste.html.twig', [
     ...
     */
    private function renderForm($formName, $contractualisation, $view, $parametres = [])
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect($do == 'save-close' ? $this->generateUrl('hopitalnumerique_user_contractualisation', ['id' => $contractualisation->getUser()->getId()]) : $this->generateUrl('hopitalnumerique_user_contractualisation_edit', ['id' => $contractualisation->getId()]));
            }
        }
