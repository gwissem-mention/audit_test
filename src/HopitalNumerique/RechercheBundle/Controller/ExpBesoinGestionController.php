...
class ExpBesoinGestionController extends Controller
{
     ...
     *
     * @param int $id id de ExpBesoinGestion
     */
    public function editAction($id)
    {
        //Récupération de l'entité passée en paramètre
        $expbesoingestion = $this->get('hopitalnumerique_recherche.manager.expbesoingestion')->findOneBy(['id' => $id]);
    ...
    public function showAction($id)
    {
        ...
        return $this->render('HopitalNumeriqueRechercheBundle:ExpBesoinGestion:show.html.twig', [
    ...
    public function getRechercheAideeGestionnaireAction()
    {
        ...
        $expbesoingestion = $this->get('hopitalnumerique_recherche.manager.expbesoingestion')->findBy([]);

        return $this->render('HopitalNumeriqueRechercheBundle:ExpBesoinGestion:Fancy/getRechercheAidee.html.twig', [
    ...
    {
        $expBesoins = $this->get('hopitalnumerique_recherche.manager.expbesoin')->findBy(['expBesoinGestion' => $id], ['order' => 'ASC']);
        $reponses = $this->get('hopitalnumerique_recherche.manager.expbesoinreponses')->getAllReponsesInArrayById();

        return $this->render('HopitalNumeriqueRechercheBundle:ExpBesoin:Fancy/tinyMCE_front.html.twig', [
    ...
    public function deleteMassAction($primaryKeys, $allPrimaryKeys)
    {
        ...
        $expBesoinGestion = $this->get('hopitalnumerique_recherche.manager.expbesoingestion')->findBy(['id' => $primaryKeys]);
    ...
    private function renderForm($formName, $expbesoingestion, $view)
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect(($do == 'save-close' ? $this->generateUrl('hopitalnumerique_recherche_admin_aide-expression-besoin_gestion') : $this->generateUrl('hopitalnumerique_recherche_admin_aide-expression-besoin_gestion_edit', ['id' => $expbesoingestion->getId()])));
            }
        }
