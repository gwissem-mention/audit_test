...
class DemandesGrid extends Grid implements IGrid
{
    ...
    {
        $colonneInitiateur  = new Column\TextColumn('interventionInitiateurType', 'Initiateur');
        ...
        $colonneChoixCMSI = new Column\TextColumn('cmsiDateChoixLibelle', 'Choix CMSI');
        $colonneChoixAmbassadeur = new Column\TextColumn('ambassadeurDateChoixLibelle', 'Choix ambassadeur');
        ...
        $colonneEvaluation->manipulateRenderCell(
            function($value, $row, $router) {
                ...
                {
                    return '<a class="btn btn-warning btn-xs" href="'.$router->generate('hopital_numerique_intervention_evaluation_voir', array('interventionDemande' => $row->getField('id'))).'"><span class="glyphicon glyphicon-edit"></span></a>';
                }
