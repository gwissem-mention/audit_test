...
class EtatTypeDerniereDemande
{
    ...
    /**
     * @var int État d'une demande initiale
     */
    private static $ETAT_TYPE_DEMANDE_INITIALE = 1;
    /**
     * @var int État d'une demande traitée par le CMSI
     */
    ...
    public function setDerniereDemandeOuverte(InterventionDemande $interventionDemande)
    {
        ...
        if ($interventionDemande->interventionEtatEstDemandeInitiale() || $interventionDemande->interventionEtatEstAttenteCmsi()) {
            ...
            $etatType = self::$ETAT_TYPE_DEMANDE_TRAITEE_CMSI;
        }
     ...
     *
     * @param int $etatTypeDerniereDemande Type d'état de la dernière demande
     */
     ...
     *
     * @return int Le type d'état pour Demande initiale
     */
     ...
     *
     * @return int Le type d'état pour Demande traitée par le CMSI
     */
     ...
     *
     * @return bool VRAI ssi la dernière demande ouverte et de type Demande traitée par le CMSI
     */
     ...
     *
     * @param int $etatType Type d'état
     */
     ...
     *
     * @return int $etatType Le type d'état en session
     */
