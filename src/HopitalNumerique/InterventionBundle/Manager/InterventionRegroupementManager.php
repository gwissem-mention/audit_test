...
class InterventionRegroupementManager extends BaseManager
{
     ...
     *
     * @return bool VRAI ssi l'utilisateur peut regrouper la demande
     */
     ...
     *
     * @return bool VRAI ssi la demande d'intervention est une demande qui a été regroupée
     */
     ...
     *
     * @return bool vRAI ssi le référent est présent dans une demande principale
     */
