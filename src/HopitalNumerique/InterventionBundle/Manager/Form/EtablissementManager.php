    ...
    public function jsonEtablissementsRegroupesParTypeOrganisme(array $criteres)
    {
        ...
        foreach ($etablissementsRegroupesParTypeOrganisme as $etablissementsRegroupes) {
            $etablissementsListeFormatee[] = [
                ...
                'libelle' => ($etablissementsRegroupes['typeOrganisme'] != null ? $etablissementsRegroupes['typeOrganisme']->getLibelle() : ''), ], 'etablissements' => [],
            ];
            foreach ($etablissementsRegroupes['etablissements'] as $etablissement) {
                $etablissementsListeFormatee[count($etablissementsListeFormatee) - 1]['etablissements'][] = [
