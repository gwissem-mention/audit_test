...
class EvaluationController extends Controller
{
    ...
    public function nouveauAction(InterventionDemande $interventionDemande)
    {
        ...
        if ($this->container->get('hopitalnumerique_intervention.manager.intervention_evaluation')->utilisateurPeutEvaluer($interventionDemande, $utilisateurConnecte)) {
            ...
            return $this->render('HopitalNumeriqueInterventionBundle:Evaluation/Form:nouveau.html.twig', [
    ...
    protected function renderForm($options, $view)
    {
        ...
        if ($form->isValid()) {
            ...
            $this->get('hopitalnumerique_intervention.manager.intervention_courriel')->envoiCourrielEvaluationRemplie($interventionDemande->getCmsi(), $interventionDemande->getAmbassadeur(), $this->generateUrl('hopital_numerique_intervention_evaluation_voir', ['interventionDemande' => $interventionDemande->getId()], true));
