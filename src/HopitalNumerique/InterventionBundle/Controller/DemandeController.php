...
class DemandeController extends Controller
{
    ...
    protected function getVueParametresVoir(InterventionDemande $interventionDemande)
    {
        ...
        if ($utilisateurConnecte->hasRoleAmbassadeur()) {
            $vueParametres['ambassadeurs'] = $this->get('hopitalnumerique_user.manager.user')->getAmbassadeurs([
                    'region' => $interventionDemande->getCmsi()->getRegion(),
            ]);
        } elseif ($this->container->get('hopitalnumerique_intervention.manager.intervention_regroupement')->utilisateurPeutRegrouperDemandes($interventionDemande, $utilisateurConnecte)) {
    ...
    public function listeAction()
    {
        ...
        } elseif ($utilisateurConnecte->hasRoleAmbassadeur()) {
