...
class InterventionDemandeType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        //->add('referent', $this->container->get('hopitalnumerique_intervention.type.user'))
                ->add('interventionType', 'entity',
                        array(
                                'choices' => $this->container->get('hopitalnumerique_intervention.manager.form_intervention_demande')
                                        ->getInterventionTypesChoices(), 'class' => 'HopitalNumerique\ReferenceBundle\Entity\Reference',
                                'property' => 'libelle', 'label' => 'Type d\'intervention souhaitée', 'empty_value' => '',
                                'required' => true))
                ->add('region', 'entity',
                        array('label' => 'Région',
                                'choices' => $this->container->get('hopitalnumerique_intervention.manager.form_user')->getRegionsChoices(),
                                'class' => 'HopitalNumerique\ReferenceBundle\Entity\Reference', 'property' => 'libelle', 'mapped' => false,
                                'required' => true,
                ...
                ->add('etablissements', 'entity',
                        array(
                                ...
                                'required' => false,
                                'attr' => array('class' => 'hopitalnumerique_interventionbundle_interventiondemande_etablissements'))) /*->add(
                                                                                                                                           'etablissements',
                                                                                                                                           'choice',
                                                                                                                                           array(
                                                                                                                                               'multiple' => true,
                ...
                ->add('referent', 'entity',
                        array('choices' => $this->container->get('hopitalnumerique_intervention.manager.form_user')->getUsersChoices(),
                                'class' => 'HopitalNumerique\UserBundle\Entity\User', 'label' => 'Référent de la demande',
                                'required' => true,
    ...
    {
        $resolver
                ->setDefaults(array('data_class' => 'HopitalNumerique\InterventionBundle\Entity\InterventionDemande'));
    }
