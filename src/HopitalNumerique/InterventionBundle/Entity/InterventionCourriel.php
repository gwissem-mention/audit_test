...
class InterventionCourriel extends Mail
{
    ...
    /**
     * @var int ID du courriel de création d'une demande d'intervention
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_CREATION_ID = 3;
    /**
     * @var int ID du courriel de demande d'acceptation ou non d'une demande d'intervention par l'ambassadeur
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_ACCEPTATION_AMBASSADEUR_ID = 4;
    /**
     * @var int ID du courriel de demande d'acceptation ou non d'une demande d'intervention par le CMSI
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_ACCEPTATION_CMSI_ID = 10;
    /**
     * @var int ID du courriel d'alerte de création de demande d'acceptation émise par un CMSI
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_ALERTE_REFERENT_ID = 5;
    /**
     * @var int ID du courriel d'acceptation d'une demande d'acceptation par un CMSI
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_EST_ACCEPTEE_CMSI_ID = 6;
    /**
     * @var int ID du courriel de refus d'une demande d'acceptation par un CMSI
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_EST_REFUSEE_CMSI_ID = 7;
    /**
     * @var int ID du courriel d'invitation du référent à évaluer une intervention
     */
    private static $COURRIEL_INVITATION_EVALUATION_REFERENT_ID = 15;
    /**
     * @var int ID du courriel de changement d'ambassadeur
     */
    private static $COURRIEL_INTERVENTION_CHANGEMENT_AMBASSADEUR_ID = 16;
    /**
     * @var int ID du courriel d'acceptation d'une demande d'acceptation par un ambassadeur
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_EST_ACCEPTEE_AMBASSADEUR_ID = 17;
    /**
     * @var int ID du courriel de refus d'une demande d'acceptation par un ambassadeur
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_EST_REFUSEE_AMBASSADEUR_ID = 18;
    /**
     * @var int ID du courriel de relance 1 d'un ambassadeur
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_RELANCE_AMBASSADEUR_1_ID = 19;
    /**
     * @var int ID du courriel de relance 2 d'un ambassadeur
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_RELANCE_AMBASSADEUR_2_ID = 20;
    /**
     * @var int ID du courriel de clôture car sans nouvelle de l'ambassadeur
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_RELANCE_AMBASSADEUR_CLOTURE_ID = 21;
    /**
     * @var int ID du courriel de l'évaluation remplie
     */
    private static $COURRIEL_EVALUATION_REMPLIE_ID = 22;
    /**
     * @var int ID du courriel d'annulation d'une demande par un établissement
     */
    private static $COURRIEL_INTERVENTION_DEMANDE_EST_ANNULEE_ETABLISSEMENT_ID = 25;
    /**
     * @var int ID du courriel de relance d'une demande en attente CMSI
     */
     ...
     *
     * @return int ID du courriel de création d'une demande d'intervention
     */
     ...
     *
     * @return int ID du courriel d'acceptation ou non d'une demande d'intervention par l'ambassadeur
     */
     ...
     *
     * @return int ID du courriel d'acceptation ou non d'une demande d'intervention par le CMSI
     */
     ...
     *
     * @return int ID du courriel d'alerte de création de demande d'acceptation émise par un CMSI
     */
     ...
     *
     * @return int ID du courriel d'acceptation d'une demande d'acceptation par un CMSI
     */
     ...
     *
     * @return int ID du courriel de refus d'une demande d'acceptation par un CMSI
     */
     ...
     *
     * @return int ID du courriel d'invitation du référent à évaluaer une intervention
     */
     ...
     *
     * @return int ID du courriel d'acceptation d'une demande d'acceptation par un ambassadeur
     */
     ...
     *
     * @return int ID du courriel de refus d'une demande d'acceptation par un ambassadeur
     */
     ...
     *
     * @return int ID du courriel de relance 1 pour l'ambassadeur
     */
     ...
     *
     * @return int ID du courriel de relance 2 pour l'ambassadeur
     */
     ...
     *
     * @return int ID du courriel de clôture car sans nouvelle de l'ambassadeur
     */
     ...
     *
     * @return int ID du courriel de l'évaluation remplie
     */
     ...
     *
     * @return int ID du courriel d'annulation d'une demande par un établissement
     */
