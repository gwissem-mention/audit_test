...
{
    /**
     * @var int Nombre de jours que le CMSI a pour mettre à jour une demande initiale avant qu'elle soit automatiquement validée
     */
    public static $VALIDATION_CMSI_NOMBRE_JOURS = 7;
    /**
     * @var int Nombre de jours avant que le CMSI reçoit une alerte s'il n'a pas mis à jour une demande d'intervention en attente
     */
    public static $NOTIFICATION_MISE_EN_ATTENTE_CMSI_NOMBRE_JOURS = 7;
    /**
     * @var int Nombre de jours avant que l'ambassadeur ne reçoive une première alerte après que la demande ait été validée par le CMSI
     */
    public static $NOTIFICATION_AVANT_RELANCE_AMBASSADEUR_1_NOMBRE_JOURS = 7;
    /**
     * @var int Nombre de jours avant que l'ambassadeur ne reçoive une seconde alerte après que la demande ait été validée par le CMSI
     */
    public static $NOTIFICATION_AVANT_RELANCE_AMBASSADEUR_2_NOMBRE_JOURS = 7;
    /**
     * @var int nombre de jours avant que la demande d'intervention, sans réponse de l'ambassadeur, soit clôturée
     */
     ...
     *
     * @return int ID de la référence correspondant à Demande initiale
     */
     ...
     *
     * @return int ID de la référence correspondant à Mise en attente par le CMSI
     */
     ...
     *
     * @return int ID de la référence correspondant à Refusé par le CMSI
     */
     ...
     *
     * @return int ID de la référence correspondant à Accepté par le CMSI
     */
     ...
     *
     * @return int ID de la référence correspondant à Accepté par le CMSI - 1ère relance ambassadeur
     */
     ...
     *
     * @return int ID de la référence correspondant à Accepté par le CMSI - 2nde relance ambassadeur
     */
     ...
     *
     * @return int ID de la référence correspondant à Refusé par l'ambassadeur
     */
     ...
     *
     * @return int ID de la référence correspondant à Accepté par l'ambassadeur
     */
     ...
     *
     * @return int ID de la référence correspondant à Terminée
     */
     ...
     *
     * @return int ID de la référence correspondant à Clôturée
     */
     ...
     *
     * @return int ID de la référence correspondant à Demande annulée
     */
