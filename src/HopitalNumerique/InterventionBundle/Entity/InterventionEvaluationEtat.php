...
class InterventionEvaluationEtat
{
     ...
     *
     * @return int ID de la référence correspondant à En attente
     */
     ...
     *
     * @return int ID de la référence correspondant à À évaluer
     */
     ...
     *
     * @return int ID de la référence correspondant à Évalué
     */
