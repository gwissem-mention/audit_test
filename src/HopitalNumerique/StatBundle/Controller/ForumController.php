...
class ForumController extends Controller
{
    ...
    {
        return $this->render('HopitalNumeriqueStatBundle:Back:partials/Forum/bloc.html.twig', []);
    }
    ...
    public function generateTableauAction(Request $request)
    {
        ...
        return $this->render('HopitalNumeriqueStatBundle:Back:partials/Forum/tableau.html.twig', [
            'stats'      => $stats,
            'forumNames' => [
                "1" => "Forum public",
                "2" => "Forum des experts",
