...
class ActiviteExpertGrid extends Grid implements GridInterface
{
    ...
    public function setActionsButtons()
    {
        ...
        $evenementButton->setAttributes(['class' => 'btn btn-success fa fa-list', 'title' => 'Gestion des évènements']);
        ...
        $contratButton->setRouteParameters(['id']);
        $contratButton->setAttributes(['class' => 'btn btn-primary fancy fancybox.ajax fa fa-file-text', 'title' => 'Contrat']);
        ...
        $payerButton->setRouteParameters(['id']);
        $payerButton->setAttributes(['class' => 'btn btn-warning fa fa-money', 'title' => 'Paiement']);
