...
class EvenementExpertGrid extends Grid implements GridInterface
{
    ...
    public function setActionsButtons()
    {
        ...
        $fancyButton->setAttributes(['class' => 'btn btn-primary fancy fancybox.ajax fa fa-users', 'title' => 'Attester les présences']);
        ...
        $downloadButton->setAttributes(['class' => 'btn btn-warning fa fa-download', 'title' => 'Télécharger la feuille d\'émargement']);
