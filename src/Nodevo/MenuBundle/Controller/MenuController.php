...
class MenuController extends Controller
{
    ...
    public function editAction($id)
    {
        ...
        $menu = $this->get('nodevo_menu.manager.menu')->findOneBy(['id' => $id]);
    ...
    private function renderForm($formName, $menu, $view)
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect(($do == 'save-close' ? $this->generateUrl('nodevo_menu_menu') : $this->generateUrl('nodevo_menu_menu_edit', ['id' => $menu->getId()])));
            }
        }
