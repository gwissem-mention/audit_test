...
class AclController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('NodevoAclBundle:Acl:index.html.twig', ['roles' => $roles, 'acls' => $acls, 'ressources' => $ressources]);
    }
    ...
    public function modifyAction()
    {
        ...
        $acl = $this->get('nodevo_acl.manager.acl')->findOneBy(['ressource' => $ressource, 'role' => $role]);
        if ($acl) {
