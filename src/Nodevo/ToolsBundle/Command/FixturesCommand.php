...
class FixturesCommand extends GeneratorCommand
{
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $bundle = $dialog->askAndValidate($output, $dialog->getQuestion('The Bundle shortcut name', $input->getOption('bundle')), ['Sensio\Bundle\GeneratorBundle\Command\Validators', 'validateBundleName'], false, $input->getOption('bundle'), $bundleNames);
