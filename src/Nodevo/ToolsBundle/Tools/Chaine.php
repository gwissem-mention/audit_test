...
class Chaine
{
    ...
    public function supprimeAccents()
    {
        $this->chaine = str_replace(
            ['À', 'Â', 'à', 'á', 'â', 'ã', 'ä', 'å', 'Ô', 'ò', 'ó', 'ô', 'õ', 'ö', 'ō', 'ø', 'È', 'É', 'Ê', 'è', 'é', 'ê', 'ë', 'Ç', 'ç', 'Î', 'ì', 'í', 'î', 'ï', 'ù', 'ú', 'û', 'ü', 'ū', 'ÿ', 'ñ'],
            ['A', 'A', 'a', 'a', 'a', 'a', 'a', 'a', 'O', 'o', 'o', 'o', 'o', 'o', 'o', 'o', 'E', 'E', 'E', 'e', 'e', 'e', 'e', 'C', 'c', 'I', 'i', 'i', 'i', 'i', 'u', 'u', 'u', 'u', 'u', 'y', 'n'],
            $this->chaine
        );
     ...
     * @param bool   $toutEnMinuscule     VRAI ssi le résultat doit être en minuscule
     *
