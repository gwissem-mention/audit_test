...
class Fichier
{
     ...
     * @param bool   $remplaceSiExistant Si FAUX le nom du fichier pourra être modifié pour ne pas à avoir à remplacer un fichier existant
     *
    ...
    public function move($nouveauChemin, $remplaceSiExistant = false)
    {
        ...
        if (is_uploaded_file($this->getChemin())) {
            ...
            $deplacementEstReussi = rename($this->getChemin(), $nouveauChemin);
        }
     ...
     * @param bool     $toutEnMinuscule    VRAI ssi le nom doit être en minuscule
     * @param int|null $longueurMaximale   Longueur maximale du fichier (extension comprise)
     * @param bool     $remplaceSiExistant Si FAUX le nom du fichier pourra être modifié pour ne pas à avoir à remplacer un fichier existant
     *
