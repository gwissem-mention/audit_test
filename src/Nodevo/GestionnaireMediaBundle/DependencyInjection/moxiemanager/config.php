<?php
	...
	// Filesystem
	$moxieManagerConfig['filesystem.rootpath'] = MOXIEMANAGER_FILESYSTEM_ROOTPATH;
	...
	// SymfonyAuthenticator
	//$moxieManagerConfig['SymfonyAuthenticator.environment'] = 'dev';
	$moxieManagerConfig['SymfonyAuthenticator.logged_in_key'] = 'isLoggedIn';
	$moxieManagerConfig['SymfonyAuthenticator.user_key'] = 'user';
	$moxieManagerConfig['SymfonyAuthenticator.config_prefix'] = 'moxiemanager';
	...
	$moxieManagerConfig['IpAuthenticator.ip_numbers'] = $_SERVER['REMOTE_ADDR'];
	...
	// Local filesystem
	$moxieManagerConfig['filesystem.local.wwwroot'] = $_SERVER['DOCUMENT_ROOT'];
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "vgu@nodevo.com", "password" => "8czuge", "groups" => array("administrator"))
	);
