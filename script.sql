...
VALUES (
NULL , '104', '1', 'Éditer des interventions', 'hopital_numerique_intervention_admin_demande_edit', NULL , '0', NULL , NULL , '1', '0', 'IS_AUTHENTICATED_ANONYMOUSLY', '1'
);
INSERT INTO `core_menu_item` (
`itm_id` ,
`itm_parent` ,
...
VALUES (
NULL , '104', '1', 'Voir une évaluation', 'hopital_numerique_intervention_admin_evaluation_voir', NULL , '0', NULL , NULL , '1', '0', 'IS_AUTHENTICATED_ANONYMOUSLY', '2'
);
