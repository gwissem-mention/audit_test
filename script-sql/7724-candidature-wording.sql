...
INSERT INTO hn_questionnaire_question (qst_id, typ_question, que_libelle, que_obligatoire, que_ordre, que_alias, que_reference_param_tri) VALUE (1, 10, "Sur quels domaines avez-vous le plus de connaissances ?", 0, 5, "fonction", "FONCTION");
