...
VALUES
    (40, '[HOPITALNUMERIQUE] - Signalement de bug', 'Signalement de bug via le formulaire', 'communication@anap.fr', 'ANAP Hôpital numérique', 'Bonjour %u,\r\n\nL\'utilisateur %rapporteur a signalé une anomalie le %date sur la page %url . \r\nVoici son userAgent : %agentUser \r\nEt son observation : %observation\r\n\nCordialement,', '{\"%u\":\"Nom d\'utilisateur\",\"%rapporteur\":\"Nom de la personne ayant relevé le bug\",\"%date\":\"Date du signalement\",\"%agentUser\":\"Information sur le navigateur et la machine de l\'utilisateur\",\"%observation\":\"Observation du rapporteur\"}');
