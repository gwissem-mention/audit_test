...
INSERT INTO core_textedynamique_code (txt_code, txt_texte) VALUE ('Module_moncompte_service_nodata', '<p>Aucune donnée</p>');
INSERT INTO core_textedynamique_code_domaine (txt_id, dom_id) SELECT (SELECT txt_id FROM core_textedynamique_code WHERE txt_code = 'Module_moncompte_service_nodata' LIMIT 1), dom_id FROM hn_domaine;
