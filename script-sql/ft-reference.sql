...
/* 15:10:19 Nodevo05 preprod_monhopitalnumerique */ ALTER TABLE `hn_requete` DROP INDEX `IDX_BA17717AC69D3FB`;
...
INSERT INTO `core_mail` (`mail_id`, `mail_objet`, `mail_description`, `mail_expediteur_mail`, `mail_expediteur_name`, `mail_body`, `mail_params`, `mail_notification_region_referent`) VALUES (null, 'Recommandation', 'Recommandation', '', '', 'Bonjour, Je te recommande cette page : %url. A+.', '', '0');
