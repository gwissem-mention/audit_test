...
INSERT INTO `core_menu_item` (`itm_id`, `itm_parent`, `mnu_menu`, `itm_name`, `itm_route`, `itm_route_parameters`, `itm_route_absolute`, `itm_uri`, `itm_icon`, `itm_display`, `itm_display_children`, `itm_role`, `itm_order`)
VALUES
    (144, 125, 1, 'Visualisation facture', 'hopitalnumerique_paiement_facture_detail', NULL, 0, NULL, NULL, 0, 0, 'IS_AUTHENTICATED_ANONYMOUSLY', 1);

UPDATE `core_menu_item` SET `itm_parent` = '68', `itm_name` = 'Session - Evaluation' WHERE `itm_id` = '140';
INSERT INTO `core_menu_item` (`itm_id`, `itm_parent`, `mnu_menu`, `itm_name`, `itm_route`, `itm_route_parameters`, `itm_route_absolute`, `itm_uri`, `itm_icon`, `itm_display`, `itm_display_children`, `itm_role`, `itm_order`) VALUES (NULL, '141', '4', 'Session - Evaluation', 'hopitalnumerique_module_evaluation_form_front', '[]', NULL, NULL, NULL, '0', '0', 'IS_AUTHENTICATED_ANONYMOUSLY', '3');
