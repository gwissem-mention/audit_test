...
UPDATE `core_mail` SET
  ...
  `mail_body` = 'Bonjour %prenomUtilisateur,<br /><br />La publication <a href=\"%urlPublication\">&quot;%titrePublication&quot;</a> vient d\'être mise à jour.<br /><br />Détail de la mise à jour :<br />%miseAJour<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
UPDATE `core_mail` SET
  ...
  `mail_body` = 'Bonjour %prenomUtilisateur,<br /><br />Un nouveau message vient d\'être posté par %pseudoAuteur sur le forum <a href=\"%urlMessage\">&quot;%forum &gt; %categorie &gt; %theme &gt; %fildiscussion&quot</a>.<br /><br />Message posté :<br />%message<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
UPDATE `core_mail` SET
  ...
  `mail_body` = 'Bonjour %prenomUtilisateur,<br /><br />Un nouveau commentaire vient d\'être posté sur <a href=\"%urlPublication\">&quot;%titrePublication&quot;</a>.<br /><br />Commentaire posté :<br />%commentaire<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
UPDATE `core_mail` SET
  ...
  `mail_body` = 'Bonjour %prenomUtilisateur,<br /><br />%prenomUtilisateurDist %nomUtilisateurDist vient de poster un nouveau commentaire sur le groupe <a href=\"%urlGroupe\">&quot;%nomGroupe&quot;</a>.<br /><br />Commentaire ajouté :<br />%commentaire<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
UPDATE `core_mail` SET
  ...
  `mail_body` = 'Bonjour %prenomUtilisateur,<br /><br />%prenomUtilisateurDist %nomUtilisateurDist vient de poster un nouveau commentaire sur la fiche <a href=\"%urlFiche\">&quot;%nomFiche&quot;</a> du groupe &quot;%nomGroupe&quot;.<br /><br />Commentaire ajouté :<br />%commentaire<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  'Bonjour %prenomUtilisateur,<br /><br />L\'autodiagnostic <a href=\"%urlAutodiagnostics\">&quot;%nomautodiag&quot;</a> vient d\'être mis à jour par l\'ANAP.<br /><br />Détail de la mise à jour :<br />%miseAJour<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />Le parcours guidé <a href=\"%urlParcoursGuides\">&quot;%nomParcours&quot;</a> vient d\'être mis à jour par l\'ANAP.<br /><br />Détail de la mise à jour :<br />%miseAJour<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />%prenomUtilisateurDist %nomUtilisateurDist vient de modifier le rapport <a href=\"%urlMonPanier\">&quot;%nomRapport&quot;</a>.<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />%prenomUtilisateurDist %nomUtilisateurDist vient de vous partager son rapport <a href=\"%urlMonPanier\">&quot;%nomRapport&quot;</a>.<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />%prenomUtilisateurDist %nomUtilisateurDist vient de partager le rapport <a href=\"%urlMonPanier\">&quot;%nomRapport&quot;</a> avec %prenomUtilisateurTo %nomUtilisateurTo.<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />%prenomUtilisateurDist %nomUtilisateurDist vient de vous copier son rapport <a href=\"%urlMonPanier\">&quot;%nomRapport&quot;</a>.<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />Une nouvelle discussion vient d\'être proposée par %pseudoAuteur sur le forum <a href=\"%urlMessage\">&quot;%forum &gt; %categorie &gt; %theme &gt; %fildiscussion&quot;</a>.<br /><br />Message posté :<br />%message<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />%prenomUtilisateurDist %nomUtilisateurDist vient de poster un nouveau fichier (&quot;%nomFichier&quot;) dans le groupe <a href=\"%urlGroupe\">&quot;%nomGroupe&quot;</a>.<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />%prenomUtilisateurDist %nomUtilisateurDist vient de s\'inscrire au groupe <a href=\"%urlGroupe\">&quot;%nomGroupe&quot;</a>.<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />Un nouveau groupe <a href=\"%urlCommunaute\">&quot;%nomGroupe&quot;</a> vient d\'être créé par l\'ANAP. La date de démarrage est prévue pour le %dateDebut.<br /><br />Description du groupe :<br />%description<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />%prenomUtilisateurDist %nomUtilisateurDist vient de s\'inscrire à la communauté de pratique.<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />Un nouvelle personne ressource est disponible dans votre région : %prenomUtilisateurDist %nomUtilisateurDist en tant que &quot;%role&quot;.<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO `core_mail` (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />Liste des prochaines sessions de montée en compétences dans les 3 mois à venir :<br /><br />%liste<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
...
INSERT INTO core_mail (
  ...
  '%mailContactDomaineCurrent',
  'ANAP - %nomContactDomaineCurrent',
  'Bonjour %prenomUtilisateur,<br /><br />lorem ... <br /><br />%message<br /><br />Cordialement,<br /><br />L\'équipe ANAP',
  '{"%prenomUtilisateur":"Prénom utilisateur", "%message":"Liste des notifications"}',
  '0'
);

UPDATE `core_mail` SET
  `mail_body` = 'Bonjour %prenomUtilisateur,<br /><br />Une nouvelle discussion vient d\'être proposée par %pseudoAuteur sur le forum <a href=\"%urlMessage\">&quot;%forum &gt; %categorie &gt; %theme &gt; %fildiscussion&quot;</a>.<br /><br />Message posté :<br />%message<br /><br />Cordialement,<br /><br />L\'équipe ANAP'
