...
INSERT INTO core_mail (mail_id, mail_objet, mail_description, mail_expediteur_mail, mail_expediteur_name, mail_body, mail_params, mail_notification_region_referent) VALUES (100, '[%subjectDomaine] - Nouvelle réponse dans la communauté de pratique', 'Réponse dans une discussion de la communauté de pratique', '%mailContactDomaineCurrent', 'ANAP - %nomContactDomaineCurrent', 'Bonjour,
...
INSERT INTO core_mail (mail_id, mail_objet, mail_description, mail_expediteur_mail, mail_expediteur_name, mail_body, mail_params, mail_notification_region_referent) VALUES (101, '[%subjectDomaine] - Une réponse est en attente de modération', 'Modération d\'une réponse dans une discussion de la communauté de pratique', '%mailContactDomaineCurrent', 'ANAP - %nomContactDomaineCurrent', 'Bonjour,
